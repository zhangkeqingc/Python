...
import os, io, sys, re, time, base64, json, webbrowser, urllib.request
...
def getCityWeather_RealTime(cityID):
    ...
    try:
        ...
        jsonDatas = json.loads(weaterInfo) #json change to dictionary
        ...
        tm = jsonDatas['weatherinfo']['time']   # 更新时间

        content = city + "    " + temp + "    " + fx + fl + "    " + sd + "    " + "    " + tm
        twitter = content
        twitters = [city,temp,fx ,fl,sd,tm]
